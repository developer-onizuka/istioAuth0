...
But in the case HTTPS with Mutual TLS, I guess Authentication might not be always needed because mTLS requires client certification in addition to server certification by CA.
